...
const tournamentDetails = [
  ...
  },
  {
    ...
    description: "На турнире будут представлены стенды ведущих компаний-работодателей. Участвуйте в активностях, выигрывайте призы и воспользуйтесь возможностью проконсультироваться с HR-специалистами о своей карьере.",
  },
];
